...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
                        ...
                        <div id="wrapper">
                            <div id="login" class="animate form">
                                <form id="authentication" autocomplete="on" method="POST" action="{{ route('login') }}" >
                                    {{ csrf_field() }}
                                    <h3 class="black_bg">
                                        <img src="{{ asset('public/img/logo.png') }}" alt="josh logo">
                                        <br>Log In</h3>
                                    <div class="form-group " {{ $errors->has('email') ? ' has-error' : '' }}>
                                        ...
                                        <input id="email1" type="email"  name="email" value="{{ old('email') }}" required autofocus />
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <input type="checkbox" name="remember-me" id="remember-me" value="remember-me"  class="square-blue" {{ old('remember') ? 'checked' : '' }} /> Keep me logged in
                                        </label>
                                    </div>
        ...
        <!-- end of global js -->
        <script src="{{ asset('public/vendors/bootstrapvalidator/js/bootstrapValidator.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('public/vendors/iCheck/js/icheck.js') }}" type="text/javascript"></script>
        <script src="{{ asset('public/js/pages/login.js') }}" type="text/javascript"></script>
    </body>
</html>
