        ...
        <div class="page-sidebar  sidebar-nav">
            ...
            <ul id="menu" class="page-sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="{{ route('pages',['id'=> 'about']) }}">
                                <i class="fa fa-angle-double-right"></i> About Page
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('pages',['id'=> 'source']) }}">
                                <i class="fa fa-angle-double-right"></i> Source Page
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('pages',['id'=> 'feature']) }}">
                                <i class="fa fa-angle-double-right"></i> Feature Page
                            </a>
                        </li>
                    </ul>
                </li>
